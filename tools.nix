    ...
    parseGitSource = source:
      assert builtins.isString source; let
        ...
        rev = let
          ...
          fromRev =
            if queryParams ? rev
            then parseCommitHash queryParams.rev
            else null;
        in
      ...
      fetchers = {
        ...
        "git" = {
          ...
          assert (sourceType package) == "git"; let
            ...
            hasExclusions = rootCargo ? "exclude";
