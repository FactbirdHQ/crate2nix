...
let
      ...
      testDerivation = pkgs.stdenv.mkDerivation {
        ...
        buildPhase =
          ...
          assert lib.length expectedTestOutputs > 0 -> derivation ? test; ''
            ...
            ${
              if lib.length expectedTestOutputs == 0
              then ''
  ...
  buildTestConfigs = [
    ...
    #
    # Super slow instantiations - however, the generated Cargo.nix file can be
    # evaluated manually
    # {
    #   name = "datafusion-test";
    #   src = ./sample_projects/datafusion;
    #   expectedOutput = "datafusion-test 0";
    # }
    {
      name = "bin";
